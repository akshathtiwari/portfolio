// Pre-render KaTeX math in the scaled-dot-product-attention blog embed to static HTML.
...
// <!--KATEX-END-->, then run:  node scripts/prerender-katex-scaled-attention.mjs
...
const file = path.join(root, 'public/blog-embeds/scaled-dot-product-attention.html');
