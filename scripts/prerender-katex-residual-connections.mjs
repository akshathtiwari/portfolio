// Pre-render KaTeX math in the residual-connections blog embed to static HTML.
...
// <!--KATEX-END-->, then run:  node scripts/prerender-katex-residual-connections.mjs
...
const file = path.join(root, 'public/blog-embeds/residual-connections.html');
