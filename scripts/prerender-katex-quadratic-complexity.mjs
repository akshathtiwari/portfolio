// Pre-render KaTeX math in the attention-quadratic-complexity blog embed to static HTML.
...
// <!--KATEX-END-->, then run:  node scripts/prerender-katex-quadratic-complexity.mjs
...
const file = path.join(root, 'public/blog-embeds/attention-quadratic-complexity.html');
