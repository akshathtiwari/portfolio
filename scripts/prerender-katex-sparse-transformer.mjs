// Pre-render KaTeX math in the sparse-transformer blog embed to static HTML.
...
// <!--KATEX-END-->, then run:  node scripts/prerender-katex-sparse-transformer.mjs
...
const file = path.join(root, 'public/blog-embeds/sparse-transformer.html');
