// Pre-render KaTeX math in the tokenization blog embed to static HTML.
// Same rationale/contract as prerender-katex-lm.mjs: no runtime KaTeX/CDN.
// Author math with $inline$ / $$display$$ between <!--KATEX-START--> and
// <!--KATEX-END-->, then run:  node scripts/prerender-katex-tokenization.mjs
...
const file = path.join(root, 'public/blog-embeds/tokenization.html');
