// Pre-render KaTeX math in the pre-transformer blog embed to static HTML.
...
// <!--KATEX-END-->, then run:  node scripts/prerender-katex-pre-transformer.mjs
...
const file = path.join(root, 'public/blog-embeds/pre-transformer.html');
