// Pre-render KaTeX math in the multi-head-attention blog embed to static HTML.
...
// <!--KATEX-END-->, then run:  node scripts/prerender-katex-multi-head-attention.mjs
...
const file = path.join(root, 'public/blog-embeds/multi-head-attention.html');
