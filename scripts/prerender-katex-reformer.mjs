// Pre-render KaTeX math in the reformer blog embed to static HTML.
// Author math with $inline$ / $$display$$ between <!--KATEX-START--> and
// <!--KATEX-END-->, then run:  node scripts/prerender-katex-reformer.mjs
...
const file = path.join(root, 'public/blog-embeds/reformer.html');
